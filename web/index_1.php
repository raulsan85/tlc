...
<html lang="es">
    ...
    <body>
        ...
        <?php
            $sql = "SELECT * FROM clientes cl"
                    . "INNER JOIN contactos c ON c.cliente_id=c.id;";
            $consulta = mysqli_query($db, $sql);
            $columnas = mysqli_fetch_assoc($consulta);
            while($columna = mysqli_fetch_assoc($consulta)){
                var_dump($columna['nombre']);
                $nombres= $columna['nombre'];
                $direcciones= $columna['direccion'];
                $postales= $columna['codigo_postal'];
                $ciudades= $columna['ciudad'];
                $provincias= $columna['provincia'];
                $paises= $columna['pais'];
                $gestores= $columna['gestor_cuentas'];
                $fecha= $columna['fecha_alta'];
                $baja= $columna['baja'];
                $divisiones= $columna['division'];
                $contactos= $columna['contacto'];
                $cargos= $columna['cargo'];
                $correos= $columna['email'];
